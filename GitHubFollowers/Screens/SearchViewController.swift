...
class SearchViewController: UIViewController {
    ...
    let usernameTextField = PLTextField()
    
    let callToActionButton = PLButton(backgroundColor: .systemGreen, title: "Get Followers")
    
    var isUsernameEntered: Bool { usernameTextField.text.isNotEmpty }
    ...
    @objc func pushFollowersListViewController() {
        guard isUsernameEntered else { 
            presentPLAlertOnMainThread(title: "Empty Username", message: "Please enter a username.", buttonTitle: "Ok")
            return
        }
